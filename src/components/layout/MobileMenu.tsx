          ...
          <nav className="relative z-10 flex flex-col items-center justify-center h-full gap-8 px-6">
                ...
                >
                  <Link
                    ...
                    className={`text-3xl font-bold tracking-wide transition-colors ${
                      isActive ? "text-rose" : "text-charcoal/70 hover:text-charcoal"
                    }`}
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full text-sm font-medium"
              >
            ...
            <motion.p
              ...
              className="absolute bottom-8 text-charcoal/40 text-sm"
            >
              {SITE_CONFIG.tagline}
            </motion.p>
          </nav>
